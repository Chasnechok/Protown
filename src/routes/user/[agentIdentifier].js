...
export async function put(req, res) {
  ...
  try {
    ...
    if (!decoded.agentIdentifier || decoded.agentIdentifier !== agentIdentifier)
      return send(res, 401, {
        error: true,
        message: 'Access denied!',
        code: 'NO_ACCESS',
  ...
  if (!user)
    return send(res, 401, {
      error: true,
      message: `User with ${agentIdentifier} identifier doesn't exist!`,
      code: 'USER_NOT_FOUND',
    })

...
<div
  ...
  class:error={notification.error || notification.code === 'VALIDATION_ERROR'}
  class="notification"
>
  ...
  {/if}
  <span
    >{notification.error || notification.code === 'VALIDATION_ERROR'
      ? notification.code
  ...
  <svg
    ...
    on:click={() =>
      (notifications = notifications.filter((el) =>
        notification.code === 'VALIDATION_ERROR'
          ? el.code !== notification.code

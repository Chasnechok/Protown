...
export const extras = derived(
    ...
    ["house", "flat", "commersion"].includes($filters.type) && $filters.deal === "lease" ? [{label: "Без комиссии", c: false, value: "fee"}, {label: "С мебелью", c: false, value: "fur"}, {label: "Скоро освобождается", c: true, value: "soonFree"}] : 
